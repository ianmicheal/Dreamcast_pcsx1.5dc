Open Source Soft driver for PcsxDC
----------------------------------                        
...
copy libgpu.a into the library search path of your cross-compiler and
compile PcsxDC again.
...
<DEL>  show/hide FPS and option menu                                            
  ...
  looks like: 'FPS XXXX.X   FL< FS  GF'                                 
  ...
  Just hit the <END>/<HOME> key to switch the selected option on or off.
  Changes be done immediatly, you can see how the framerate is affected if
  an option is on or off.                                                           

----------------------------------------------------------------------    

Please send any questions concerning the Dreamcast version to:

	grilenkov@x-mail.net
...
This plugin is under GPL... check out the license.txt file for details.                                                          
